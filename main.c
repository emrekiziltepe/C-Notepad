...
int menu_secim_kontrol=0,secilen_eleman_sayisi=0;
...
void Listele(){
    ...
    printf("\n\n\n\n***************************************************");
    printf("\nSayfa No : %d",(imlec_konum/50)+1);
    printf("\nImlec Satir No : %d",(imlec_konum/10)+1);
...
void Bilgilendirme(){
    ...
    printf("\n\t  CTRL+C : KOPYALA");
    printf("\n\t  CTRL+V : YAPISTIR");
    printf("\n\t  CTRL+S : DOSYAYI KAYDET");
    printf("\n\t  CTRL+O : DOSYAYI AC");
    printf("\n\t  Kes ve Kopyala fonksiyonlari icin imleci");
    printf("\n\t  1 -> Sol");
    printf("\n\t  3 -> Sag");
    printf("\n\t  5 -> Yukari");
    printf("\n\t  2 -> Asagi");
